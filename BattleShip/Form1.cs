...
namespace BattleShip
{
    public partial class Form1 : Form
    {
        ...
        private void Player_Click(object sender, EventArgs e)   // Player Click Event
        {
            ...
            // If either ships are hit...
            if (ComputerBoard[xAttack, yAttack].ImageLocation == @"..\net6.0-windows\boat.png" || ComputerBoard[xAttack, yAttack].ImageLocation == @"..\net6.0-windows\boat2.png") 
            {
        ...
        private bool WinCheck()
        {
            ...
            if(playerHitCount == 4) { MessageBox.Show("Player Wins!");
